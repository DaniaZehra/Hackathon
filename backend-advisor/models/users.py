...
class User(Document):
    ...
    transaction_history = ListField(DictField())  # Financial transactions only
    agent_history = ListField(DictField())  # Agent memory/advice records
